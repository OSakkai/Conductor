    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.login = function (loginDto) {
            return __awaiter(this, void 0, void 0, function () {
                var nome_usuario, senha, user, isPasswordValid, payload, access_token;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            nome_usuario = loginDto.nome_usuario, senha = loginDto.senha;
                            return [4 /*yield*/, this.usersService.findByUsername(nome_usuario)];
                        case 1:
                            user = _a.sent();
                            if (!user) {
                            ...
                            return [4 /*yield*/, bcrypt.compare(senha, user.senha)];
                        case 2:
        ...
        AuthService_1.prototype.register = function (createUserDto) {
            return __awaiter(this, void 0, void 0, function () {
                var user, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
