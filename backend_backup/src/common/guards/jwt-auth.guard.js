...
var JwtAuthGuard = function () {
    ...
    var JwtAuthGuard = _classThis = /** @class */ (function () {
        function JwtAuthGuard_1(jwtService, reflector) {
            this.jwtService = jwtService;
            this.reflector = reflector;
        }
        JwtAuthGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var request, token, payload_1, requiredRoles, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            return [2 /*return*/, requiredRoles.some(function (role) { var _a; return (_a = payload_1.permissao) === null || _a === void 0 ? void 0 : _a.includes(role); })];
                        case 3:
                            _a = _b.sent();
        ...
        JwtAuthGuard_1.prototype.extractTokenFromHeader = function (request) {
            var _a, _b;
