...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.findByUsername = function (nome_usuario) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        UsersService_1.prototype.create = function (userData) {
            return __awaiter(this, void 0, void 0, function () {
                var existingUser, existingEmail, saltRounds, hashedPassword, user, savedUser, senha, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.findByUsername(userData.nome_usuario)];
                        case 1:
                        ...
                        case 2:
                            ...
                            saltRounds = 10;
                            return [4 /*yield*/, bcrypt.hash(userData.senha, saltRounds)];
                        case 3:
                            hashedPassword = _a.sent();
                            user = this.usersRepository.create(__assign(__assign({}, userData), { senha: hashedPassword }));
                            return [4 /*yield*/, this.usersRepository.save(user)];
                        case 4:
                            savedUser = _a.sent();
                            senha = savedUser.senha, result = __rest(savedUser, ["senha"]);
        ...
        UsersService_1.prototype.updateUser = function (id, updateData) {
            return __awaiter(this, void 0, void 0, function () {
                var user, saltRounds, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            if (!updateData.senha) return [3 /*break*/, 3];
                            saltRounds = 10;
                            _a = updateData;
                            return [4 /*yield*/, bcrypt.hash(updateData.senha, saltRounds)];
                        case 2:
                            _a.senha = _b.sent();
                            _b.label = 3;
                        case 3: return [4 /*yield*/, this.usersRepository.update(id, updateData)];
                        case 4:
                            _b.sent();
        ...
        UsersService_1.prototype.deactivateUser = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.usersRepository.update(id, {
