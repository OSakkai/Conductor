...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.register = function (createUserDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.register(createUserDto)];
                });
            });
        };
        ...
        AuthController_1.prototype.validateToken = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.validateToken(body.token)];
                });
            });
        };
        AuthController_1.prototype.test = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, {
    ...
    (function () {
        ...
        _register_decorators = [(0, common_1.Post)('register'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, roles_decorator_1.Roles)(user_entity_1.UserPermission.ADMINISTRADOR, user_entity_1.UserPermission.DESENVOLVEDOR)];
        _getProfile_decorators = [(0, common_1.Get)('profile'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
        _validateToken_decorators = [(0, common_1.Post)('validate'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
